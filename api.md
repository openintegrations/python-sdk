...
- <code title="post /v2/connection">client.<a href="./src/openint/_client.py">create_connection</a>(\*\*<a href="src/openint/types/client_create_connection_params.py">params</a>) -> object</code>
...
- <code title="get /v2/connection/{id}">client.<a href="./src/openint/_client.py">get_connection</a>(id, \*\*<a href="src/openint/types/client_get_connection_params.py">params</a>) -> object</code>
...
- <code title="get /v2/connection">client.<a href="./src/openint/_client.py">list_connections</a>(\*\*<a href="src/openint/types/client_list_connections_params.py">params</a>) -> SyncOffsetPagination[object]</code>
...
- <code title="post /v1/connect/post-connect">client.<a href="./src/openint/_client.py">post_connect</a>(\*\*<a href="src/openint/types/client_post_connect_params.py">params</a>) -> <a href="./src/openint/types/post_connect_response.py">PostConnectResponse</a></code>
...
- <code title="put /v2/organization/{org_id}">client.<a href="./src/openint/_client.py">upsert_organization</a>(org_id, \*\*<a href="src/openint/types/client_upsert_organization_params.py">params</a>) -> <a href="./src/openint/types/upsert_organization_response.py">UpsertOrganizationResponse</a></code>
